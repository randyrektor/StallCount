    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <div style={styles.content}>
          ...
          {/* Export Section */}
          <div style={styles.section}>
            <h3 style={styles.sectionTitle}>Export Score</h3>
            <p style={styles.exportDescription}>
              Download a copy of the current game state including scores, current line, and roster.
            </p>
            <button style={{ ...styles.button, ...styles.exportButton }} onClick={handleExportScore}>
              📄 Export Score Report
            </button>
          </div>
        </div>
